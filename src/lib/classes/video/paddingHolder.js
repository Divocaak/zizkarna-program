...
export class PaddingElement {
	 ...
	 */
	getTop() {
		return typeof this.y === 'number' ? this.y : this.y.top;
	}
	 ...
	 */
	getBottom() {
		return typeof this.y === 'number' ? this.y : this.y.bottom;
	}
	 ...
	 */
	getY() {
		return typeof this.y === 'number' ? 2 * this.y : this.y.top + this.y.bottom;
	}
	 ...
	 */
	getLeft() {
		return typeof this.x === 'number' ? this.x : this.x.left;
	}
	 ...
	 */
	getRight() {
		return typeof this.x === 'number' ? this.x : this.x.right;
	}
	 ...
	 */
	getX() {
		return typeof this.x === 'number' ? 2 * this.x : this.x.left + this.x.right;
	}
}
