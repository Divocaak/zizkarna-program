...
const videoElements = (data) => [
	...
	new TextVideoElement({
		...
		posX: [
			{ time: bandIn + 0.1, value: outputDimensions.w },
			{ time: bandContent, value: 0 },
			{ time: bandOut, value: 0 },
	...
	new TextVideoElement({
		...
		posX: [
			{ time: bandIn + 0.2, value: outputDimensions.w },
			{ time: bandContent, value: 0 },
			{ time: bandOut, value: 0 },
	...
	new TextVideoElement({
		...
		posX: [
			{ time: bandIn + 0.3, value: outputDimensions.w },
			{ time: bandContent, value: 0 },
			{ time: bandOut, value: 0 },
			{ time: bandEnd, value: outputDimensions.w * -1.5 }
		],
	...
	new ImageVideoElement({
		...
		posX: 0,
		posY: [
			{ time: zzIn + 0.2, value: -outputDimensions.w },
	...
	new TextVideoElement({
		...
		content: data.doors,
		posX: [
			{ time: zzIn + 0.1, value: outputDimensions.w * 1.5 },
			{ time: zzContent, value: 0 }
		],
		posY: 1050,
		fontName: 'Neue Machina Regular',
	...
	data.tickets != null
		? new TextVideoElement({
				...
				posX: [
					{ time: zzIn + 0.2, value: outputDimensions.w * 1.5 },
					{ time: zzContent, value: 0 }
				],
				posY: 1200,
				fontName: 'Neue Machina Regular',
